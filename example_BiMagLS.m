...
%% Plot mag/phase errors per method, N=3
% Load data from file
names = {
    'ord03_MagLS'
    'ord03_TA'
...
for i=1:n
    ...
    if i==n
        ...
        c.Position = [0.89 c.Position(2) c.Position(3) c.Position(4)];
    end
end 

ax = axes('innerposition',[0.3 0.05 0.4 0.3]);
violinplot(PSD(indLeb,1:end),[],'ShowData',false,'BoxWidth',0.03); grid on
